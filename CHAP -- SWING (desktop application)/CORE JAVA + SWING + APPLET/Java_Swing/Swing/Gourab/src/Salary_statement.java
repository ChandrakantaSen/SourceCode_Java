...
public class Salary_statement extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jTextField3.setText(""+0.02*basic);
        jTextField4.setText(""+0.01*basic);
        jTextField5.setText(""+0.01*basic);
        double gross = basic + 0.02*basic+0.01*basic+0.01*basic;
        double net;
        jTextField6.setText(""+gross);
        jTextField7.setText(""+0.02*gross);
        jTextField8.setText(""+0.01*gross);
        net = gross - 0.02*gross-0.01*gross;
