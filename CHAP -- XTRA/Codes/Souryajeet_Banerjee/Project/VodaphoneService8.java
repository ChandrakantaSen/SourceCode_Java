...
import java.util.*;
public class VodaphoneService8
{
    InputStreamReader read=new InputStreamReader(System.in);
    BufferedReader in=new BufferedReader(read);
    static int k,count=0;
    static String mini_state[]=new String[100];
       ...
       for(int g=0;g<=100;g++)
       {
        ...
        if(o==86)
        {
          ...
          for(int s=0;s<=31;s++)
          {
            ...
            System.out.println("                  ****************************************************************       ");
            System.out.println("                  ****************************************************************       ");
            System.out.println("                  ** 1;        For balence information                          **");
            System.out.println("                  ** 2;        For datapackage information                      **");
            System.out.println("                  ** 3;        For acount information or update                 **");
            System.out.println("                  ** 4;        For recharge                                     **");
            System.out.println("                  ** 5;        For datapackage update                           **");
            System.out.println("                  ** 6;        For My delights                                  **");
            System.out.println("                  ** 7;        For last 3 actyities                             **");
            System.out.println("                  ** 8;        For Vass and service                             **");
            System.out.println("                  ** 9;        For Bonus Card                                   **");
            System.out.println("                  ** 10;        For Best Offer                                  **");
            System.out.println("                  ** 11;        For Low Balence Services                        **");
            System.out.println("                  ** 12;        To Exit then press o                            **");
            System.out.println("                  ****************************************************************       ");
            System.out.println("                  ****************************************************************       ");
            int n;
        ...
        System.out.println("                  **********************************************************************       ");
        System.out.println("                  ** IF YOU ARE A VODAPHONE USER                                      **");
        System.out.println("                  ** Press 1 to continue or press 0 to break                          **");
        System.out.println("                  ** IF YOU ARE NOT A VODAPHONE USER THEN PRESS 0 TO EXIT IMMIDIATELY **");
        System.out.println("                  **********************************************************************       ");
        m=Integer.parseInt(obj.readLine());
        if(m==0)
        {
