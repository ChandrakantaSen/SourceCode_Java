...
public class Bank
{
    ...
    // --> Account Details
    // A/C Holder names
    String names[]={"Shane","Harris","Sourav","Rick","Areeb"};
    ...
    void head() // The header of the Bank
    {
        ...
        System.out.println("");
        System.out.println("       ****************************************************************       ");
        System.out.println("       ***            Welcome to State Bank of India's Bank          ***       ");
        System.out.println("       ****************************************************************       ");
        System.out.println("");
    ...
    int login()throws IOException // The login part of Bank
    {
        Bank ob=new Bank();
        long card;
        int pin,i,f=0;
    ...
    void options()throws IOException // The various options of Bank
    {
        Bank ob=new Bank();
        int opn;
        System.out.println("                  Welcome "+names[k]);
        System.out.println("                  A/C no: "+acc_no[k]);
        System.out.println("                  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~        ");
