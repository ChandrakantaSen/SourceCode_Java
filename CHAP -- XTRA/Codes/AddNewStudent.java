...
/* database connectivity with MS-Access is done by creating DataSourceName(dsn) in this example*/
   /* Steps to use this example: go to ms-access and make a table called "student_base" 
                                 and give it a file name student_base.mdb
 * 1.	Go to Control Panel
   ...
   9.	Browse on the database name you have created and click it:student_base.mdb is a database file where all data
        will be stored
  10.	Click on OK.
...
public class AddNewStudent extends JFrame implements ActionListener {
 ...
 public void actionPerformed(ActionEvent e)
 {
   if(e.getSource()==btnok)
   {
    ...
    //upon clickin button addnew , your textfield will be empty to enter next record
